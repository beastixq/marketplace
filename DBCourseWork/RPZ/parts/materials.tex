...
\bibitem{mysql_doc} MySQL 8.4 Reference Manual. URL: \url{https://dev.mysql.com/doc/refman/8.4/en/} (дата обращения: 25.03.2026).

\bibitem{sqlite_doc} SQLite Documentation. URL: \url{https://www.sqlite.org/docs.html} (дата обращения: 25.03.2026).

\bibitem{redis_doc} Redis Documentation. URL: \url{https://redis.io/docs/} (дата обращения: 25.03.2026).

\bibitem{go_doc} The Go Programming Language Documentation. URL: \url{https://go.dev/doc/} (дата обращения: 25.03.2026).

\bibitem{goose_doc} Goose Database Migration Tool. URL: \url{https://github.com/pressly/goose} (дата обращения: 25.03.2026).

\bibitem{http_semantics} Fielding~R., Nottingham~M., Reschke~J. HTTP Semantics. RFC 9110. URL: \url{https://www.rfc-editor.org/rfc/rfc9110} (дата обращения: 25.03.2026).
