...
var (
	...
	ErrAddToFavorites          = errors.New("Failed to add product to favorites")
	ErrGetFavorites            = errors.New("Failed to get favorites")
	ErrRemoveFromFavorites     = errors.New("Failed to remove from favorites")
