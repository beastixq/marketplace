...
var (
	...
	ErrGetFavoriteProducts     = errors.New("Failed to get favorite products")
	ErrAddFavoriteProduct      = errors.New("Failed to add favorite product")
	ErrRemoveFavoriteProduct   = errors.New("Failed to remove favorite product")
	ErrCheckFavoriteProduct    = errors.New("Failed to check favorite product")
