...
var (
	...
	ErrCreateFavorite          = errors.New("Failed to create product favorite")
	ErrDeleteFavorite          = errors.New("Failed to delete product favorite")
	ErrGetFavorites            = errors.New("Failed to get favorite products")
	ErrCheckFavorite           = errors.New("Failed to check product favorite")
