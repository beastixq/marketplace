...
- [X] T017 [P] [US1] Add handler tests for authenticated `POST /api/v1/products/{id}/favorite`, missing auth, invalid id, missing product, and inactive product in `internal/handler/favorite_handler_test.go`
...
- [X] T021 [US1] Register authenticated `POST /api/v1/products/{id}/favorite` outside role-specific groups in `internal/handler/router.go`
...
- [X] T025 [P] [US2] Add handler tests for repeated `POST /api/v1/products/{id}/favorite` returning `204 No Content` after the first create in `internal/handler/favorite_handler_test.go`
...
- [X] T028 [US2] Return `201 Created` for new favorites and `204 No Content` for already-present favorites in `internal/handler/favorite.go`
...
- [X] T031 [P] [US3] Add handler tests for `DELETE /api/v1/products/{id}/favorite`, `GET /api/v1/products/{id}/favorite`, and `GET /api/v1/users/me/favorites` in `internal/handler/favorite_handler_test.go`
...
- [X] T036 [US3] Register authenticated `DELETE /api/v1/products/{id}/favorite`, `GET /api/v1/products/{id}/favorite`, and `GET /api/v1/users/me/favorites` routes in `internal/handler/router.go`
...
Task: "Add handler tests for authenticated POST /api/v1/products/{id}/favorite, missing auth, invalid id, missing product, and inactive product in internal/handler/favorite_handler_test.go"
```
